...
public class RightJoinOperationTest {
    ...
    public void test_all_match() {
        RightJoinOperation<Integer, String, String> joiner=new RightJoinOperation<>();
    ...
    public void test_no_match() {
        ...
        Collection<JoinedDataRow<Integer, String, String>> result = joiner.join(leftCollection, rightCollection);
        assertEquals(3, result.size());
        assertTrue(result.contains(new JoinedDataRow<>(3, null, "Rome")));
        assertTrue(result.contains(new JoinedDataRow<>(4, null, "Madrid")));
        assertTrue(result.contains(new JoinedDataRow<>(5, null, "Lisbon")));
    ...
    public void test_no_left_set() {
        ...
        Collection<JoinedDataRow<Integer, String, String>> result = joiner.join(leftCollection, rightCollection);
        assertEquals(3, result.size());
        assertTrue(result.contains(new JoinedDataRow<>(0, null, "Kyiv")));
        assertTrue(result.contains(new JoinedDataRow<>(4, null, "Madrid")));
        assertTrue(result.contains(new JoinedDataRow<>(2, null, "Paris")));
    }
}
